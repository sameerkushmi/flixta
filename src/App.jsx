...
function App() {
  ...
  return (
    <div>
        {/* headers */}
        <nav className="flex justify-between items-center  bg-white px-16 py-6 z-10 sticky top-0 left-0">
          <div>
          ...
          <div className="flex items-center gap-10 text-sm font-medium">
            ...
            <button className="rounded-[50px] flex items-center gap-2 hover:bg-black bg-[#5777FF] font-medium text-lg text-white py-[15px] px-8">
              <a href="#">Let's Talk</a>
        ...
        {/* hero section */}
        <div className="flex justify-between relative py-24 px-4 bg-[url('/images/Main-Bg.png')]">
          {/* left hero content */}
          <div className="space-y-6">
            ...
            <h1 className="text-[65px] font-bold">I'm William Isaac</h1>
            <h2 className="text-5xl font-bold text-[#5777ff]">Content Writer</h2>
            <p className="text-xl text-neutral-600">Since 1999, we are working for business, agency or individuals for <br /> building digital content based in New York, USA.</p>
            <div className="flex items-center gap-6 pt-6">
              <div>
                <button className="p-8 text-xl hover:rotate-45 transition-all duration-300 rounded-full bg-[#5777ff] text-white">
          ...
          <div className="pr-8 relative">
            ...
            <div className="absolute top-[44%] left-[10%] bg-[#5777ff] text-white rounded-full px-12 py-[36px] text-center">
              <h1 className="text-4xl font-bold mb-4">30+</h1>
              <p className="font-medium">Year of <br /> Experience</p>
            </div>
          </div>
          <img src="/images/bnr-szape3.png" alt="bnr-szape3" className="absolute bottom-0 left-[50%]" />
        </div>
        {/* clients */}
        <div className="px-8 py-24 bg-[#F2F4FF] space-y-4">
        ...
        {/* service */}
        <div className="px-4 py-24 space-y-6 bg-[#F9FAFF]">
         <div className="flex gap-3 justify-center items-center">
            <img src="/images/bnr-szape03.png" alt="szape03" className="w-8" />
          ...
          <div className="grid grid-cols-4 gap-8">
            <div className="p-5 bg-white rounded space-y-8 hover:border-blue-600 border border-white transition duration-300">
        ...
        <div className="flex flex-col items-center gap-6 py-24 bg-[#F2F4FF]">
            ...
            <h1 className="text-center text-4xl font-bold">My Work Exprience</h1>
            {/* google */}
            <div className="border border-blue-200 bg-white w-9/12">
              ...
              <div className="flex  items-center gap-8 bg-[#F9FAFF] py-12 px-24">
        ...
        {/* feedback */}
        <div className="px-4 py-24 space-y-6 bg-[url('/images/map-transparent.png')]">
            <div className="flex gap-3 justify-center items-center">
              <img src="/images/bnr-szape03.png" alt="szape03" className="w-8" />
        ...
        {/* about us*/}
        <div className="px-4 py-24 flex gap-10 bg-[#F2F4FF]">
          <div>
            <img src="/images/org-writer-500x500.jpg" alt="writer" className="rounded-full w-[445px]" />
          </div>
          <div className="px-4 space-y-6 w-7/12">
            ...
            <button className="rounded-full bg-[#5777ff] p-8 hover:rotate-45 transition duration-300">
              <svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" viewBox="0 0 17 17" fill="none">
                  <path 
                    d="M16.1421 1.33345C16.1421 0.781166 15.6944 0.33345 15.1421 0.33345L6.14214 0.333451C5.58985 0.333451 5.14214 0.781166 5.14214 1.33345C5.14214 1.88574 5.58985 2.33345 6.14214 2.33345L14.1421 2.33345L14.1421 10.3335C14.1421 10.8857 14.5899 11.3335 15.1421 11.3335C15.6944 11.3335 16.1421 10.8857 16.1421 10.3335L16.1421 1.33345ZM1.70711 16.1827L15.8492 2.04056L14.435 0.626344L0.292893 14.7685L1.70711 16.1827Z"
                    fill="white"
            ...
            <div className="flex flex-col items-center">
              {
                faqList.map((item,i)=>(
                  <div key={i} className="border-b w-10/12 cursor-pointer" onClick={()=> setOpen(i)}>
                    <div className="flex justify-between items-center text-2xl font-semibold my-6">
        ...
        {/* update */}
        <div className="py-28 px-6 bg-[#F9FAFF] space-y-6">
          <div className="flex gap-3 justify-center items-center">  
            <img src="/images/bnr-szape03.png" alt="szape03" className="w-8" />
        ...
        {/* contact */}
        <div className="py-24 flex items-center gap-6 bg-[#F2F4FF]">
          ...
          <div className="w-full pl-[150px]">
            <div className="bg-white p-16 rounded-lg">
              <form className="grid grid-cols-2 gap-8">
                <input type="text" name="fullName" placeholder="Full Name" className="border p-5 rounded bg-[#F9FAFF] outline-none" />
                <input type="email" name="email" placeholder="Email Address" className="border p-5 rounded bg-[#F9FAFF] outline-none"  />
                <input type="text" name="mobile" placeholder="Your Phone" className="border p-5 rounded bg-[#F9FAFF] outline-noe"  />
                <select className="border p-5 rounded bg-[#F9FAFF] outline-none"  name="service">
                ...
                <textarea className="col-span-2 border outline-none rounded bg-[#F9FAFF] p-5" name="message" cols="30" rows="10" placeholder="Write Your Message">
                </textarea>
        ...
        <div className="flex flex-col items-center justify-center py-16 space-y-8">
          ...
          <div className="flex items-center gap-8 text-xl font-[400] text-neutral-600">
            <button className="hover:text-[#5777FF]">
              <a href="#">Home</a>
            </button>
            <button className="hover:text-[#5777FF]">
          ...
          <p className="text-lg text-neutral-600">© 2024 Flixta. Designed by RSTheme with ❤️.</p>
        </div>
    </div>
  )
}
